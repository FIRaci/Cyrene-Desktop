...
// mock electron — sync functions do not depend on it during import, but precautionary
vi.mock("electron", () => ({
  app: { getPath: vi.fn() },
  ipcMain: { handle: vi.fn() },
}));

// vi.mock factory is hoisted to top of file and cannot reference top-level const;
// vi.hoisted hoists mock functions before mock factory.
