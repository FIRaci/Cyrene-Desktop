...
export interface ActionCapability {
  ...
  toolId: string;
  description: string;
  /** Truly required regular parameters in Runtime schema; empty array indicates no need to prompt user for params. */
...
export interface RunActionGateInput {
  ...
  /** Trusted defaults and paths generated by local main process, not user/model text. */
  ...
  /** Previous Action Gate failure info passed from graph refresh node for model reference during re-decision. */
